...
GameView.prototype.drawStats = function () {
  ...
  $(".hud").append("<li>Hippo top Points: " + this.game.hippo.points + "</li>")
  $(".hud").append("<li>Hippo bottom Points: " + this.game.hippo2.points + "</li>")
...
GameView.prototype.bindKeyHandlers = function () {
  ...
  $(document).keydown(function(event){
    event.preventDefault()
    this.parsekeyPress(event.keyCode)
  }.bind(this))
...
GameView.prototype.parsekeyPress = function(keycode){
